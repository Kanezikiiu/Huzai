...
最新版本：**[v1.183](https://github.com/Kanezikiiu/Huzai/releases/tag/v1.183)** ·
[`huzai-1.183-release.apk`](https://github.com/Kanezikiiu/Huzai/releases/download/v1.183/huzai-1.183-release.apk)（minSdk 24，正式签名）。
