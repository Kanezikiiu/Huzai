...
最新版本：**[v1.184](https://github.com/Kanezikiiu/Huzai/releases/tag/v1.184)** ·
[`huzai-1.184-release.apk`](https://github.com/Kanezikiiu/Huzai/releases/download/v1.184/huzai-1.184-release.apk)（minSdk 24，正式签名）。
